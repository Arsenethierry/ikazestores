...
export const ProductsFilters: FC<FiltersProps> = ({ filters, onFiltersChange, isLoading = false }) => {
    ...
    return (
        <div className="mb-6 space-y-4">
            <Tabs value={filters.view || 'all'} onValueChange={(value) => handleFilterChange('view', value)}>
