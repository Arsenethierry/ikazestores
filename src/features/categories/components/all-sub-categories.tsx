...
export const AllSubCategories = ({ subcategories, isSystemAdmin }: { subcategories: DocumentType[], isSystemAdmin: boolean }) => {
                ...
                {subcategories.map((category) => (
                    ...
                    >
                        <div className='flex items-center gap-4'>
                            ...
                            />
                            <span className='font-medium'>{category.subCategoryName}</span>
                        </div>
