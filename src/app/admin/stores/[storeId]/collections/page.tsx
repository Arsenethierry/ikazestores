...
async function CollectionsPage({
    ...
    const collections = await getAllCollectionsByStoreId({ storeId });
        ...
        <div className='w-full max-w-7xl space-y-5'>
            <div className='flex justify-between items-center'>
                ...
                {(isPhysicalStoreOwner || isVirtualStoreOwner) && (
                    <Link href={`/admin/stores/${storeId}/collections/new`} className={buttonVariants()}>
            ...
            {collections.total === 0 ? (
                ...
                collections.documents.map(collectionData => (
                    <Card key={collectionData.$id}>
                        ...
                        <Link href={`/admin/stores/${storeId}/collections/${collectionData.$id}`}>
                            <CardContent>
