...
//     const { productTypeId, storeId } = await params;
//     const { user } = await getAuthState();

//     return (
//         <div className="container mx-auto py-6">
//             <Suspense fallback={<ProductTypeDetailsPageSkeleton />}>
//                 <ProductTypeDetailsContent user={user} productTypeId={productTypeId} storeId={storeId} />
//             </Suspense>
//         </div>
//     );
// }

// async function ProductTypeDetailsContent({ productTypeId, storeId, user }: { productTypeId: string, storeId: string, user: CurrentUserType }) {
...
//                 backUrl={`/admin/stores/${storeId}/product-types`}
//             />
//         );
//     }
...
//                         </Button>
//                     </Link>
//                     <Link href={`/admin/stores/${storeId}/products?productType=${productTypeId}`}>
//                         <Button>
